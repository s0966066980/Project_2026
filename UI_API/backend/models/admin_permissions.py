...
ADMIN_PERMISSION_CATALOG: tuple[tuple[str, str], ...] = (
    ...
    ("optimization.manage", "Create, edit, and delete Daily Diagnostic Questions"),
    ("optimization.evidence.read", "Expand de-identified optimization evidence after step-up"),
    ("voice.evidence.summary", "Read de-identified Voice Evidence metadata and projection status"),
